...
FLAGS := -g -Wall -Wextra -Wshadow-all -pedantic -pedantic-errors -ftemplate-backtrace-limit=4 -fdiagnostics-show-category=name -Wno-gcc-compat -Wno-trigraphs -Wno-pessimizing-move -Wno-dtor-name -Wno-nested-anon-types -Wno-gnu-anonymous-struct -Wno-c23-extensions -Werror=unused-result -Wno-c99-designator
# FLAGS := -g -Wall -Wextra -Wshadow-all -pedantic -pedantic-errors -ftemplate-backtrace-limit=4 -fdiagnostics-show-category=name -Wno-gcc-compat -Wno-trigraphs -fsanitize=address -fno-omit-frame-pointer -fno-optimize-sibling-calls -Werror=unused-result
# COMPILER := g++ -std=c++23
# FLAGS := -g -Wall -Wextra -Wshadow-all -pedantic -pedantic-errors -ftemplate-backtrace-limit=4 -Wno-trigraphs -Wno-attributes -Wno-parentheses -Wno-class-memaccess -Wno-pessimizing-move -Werror=unused-result
