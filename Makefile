...
FLAGS := -g -Wall -Wextra -Wshadow-all -pedantic -pedantic-errors -ftemplate-backtrace-limit=4 -fdiagnostics-show-category=name -Wno-gcc-compat -Wno-trigraphs -Wno-pessimizing-move -Wno-dtor-name -Wno-nested-anon-types -Wno-gnu-anonymous-struct -Wno-c23-extensions -Werror=unused-result
