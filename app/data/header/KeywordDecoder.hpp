...
class clef::KeywordDecoder {
   private:
      static constexpr std::pair<frozen::string, clef::KeywordID> _mapBuf[] = {
         ...
         {"auto", KeywordID::AUTO},
         {"char", KeywordID::CHAR},
         {"char8", KeywordID::CHAR_8},
         {"char16", KeywordID::CHAR_16},
         {"char32", KeywordID::CHAR_32},
         {"bool", KeywordID::BOOL},
         {"ubyte", KeywordID::UBYTE},
         {"ushort", KeywordID::USHORT},
         {"uint", KeywordID::UINT},
         {"ulong", KeywordID::ULONG},
         {"uoverlong", KeywordID::UOVERLONG},
         {"uptr", KeywordID::UPTR},
